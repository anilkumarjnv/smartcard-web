                                                ...
                                                {confirmDeleteId === card.id ? (
                                                    <div className="flex flex-col items-center justify-center space-y-4 w-full h-full animate-in fade-in zoom-in duration-200">
                                                        <div className="text-center">
                                                            <h4 className="text-lg font-bold text-white dark:text-neutral-900 mb-1">Delete Card?</h4>
                                                            <p className="text-sm text-neutral-300 dark:text-neutral-600 px-4">
                                                    ...
                                                    <div className="flex flex-col items-center justify-center w-full h-full animate-in fade-in zoom-in duration-200 text-white dark:text-neutral-900 p-2">
