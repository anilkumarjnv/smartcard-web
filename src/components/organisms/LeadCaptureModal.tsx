...
import { Button } from '@/components/molecules/Button'; // Assuming we have Button in molecules, step 1001 confirmed it.
        ...
        <Modal isOpen={isOpen} onClose={handleClose} title="Connect with me" size="sm">
            {success ? (
                <div className="flex flex-col items-center justify-center py-8 text-center animate-fadeIn">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Info Sent & Downloaded!</h3>
                    ...
                    <div className="flex flex-col gap-3 w-full">
                        <Button
                            ...
                            className="w-full flex items-center justify-center gap-2 bg-neutral-100 text-neutral-900 hover:bg-neutral-200 border-0"
                        >
